#!/usr/bin/env python3
"""
Generic Corp NAP Fabric Topology Generator
...
Example:
    python3 nap_fabric_generator.py bjs11-11
    python3 nap_fabric_generator.py nrt55-62
"""
...
def group_devices(devices):
    """Group r101 and r102 devices into r10[12], r1 and r2 into r[12]"""
    device_groups = defaultdict(list)
    
    for device in devices:
        # Extract base name (everything before r101/r102 or r1/r2)
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python3 nap_fabric_generator.py <site>")
        print("Example: python3 nap_fabric_generator.py bjs11-11")
        sys.exit(1)
    ...
    print(f"    ReadInternalWebsites tool with URL: {url}")
    print("\nThen paste the content below and press Ctrl+D:")
    print("-" * 70)
    
    # Read .attr content from stdin
    attr_content = sys.stdin.read()
